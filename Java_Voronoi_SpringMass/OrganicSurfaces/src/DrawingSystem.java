...
//			springs.add(s);
	...
	public void setSpringsUniformTriangulation() {
		...
		for(Mass m1 : masses) {
			...
			connect(m1, nearestM1, 1, 1, nearest1, false);		//TODO not sure what ks and kd should be
			connect(m1, nearestM2, 1, 1, nearest2, false);
		}
	}
